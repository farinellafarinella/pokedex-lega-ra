...
async function mountSafari(host, { client, isCurrent = () => true, onBalance = () => {
  ...
  root.innerHTML = `<link rel="stylesheet" href="${new URL("./style.css", scriptURL)}"><main><div class="eyebrow">ESPLORA \xB7 SCEGLI \xB7 CATTURA</div><h1>Zona Safari</h1><p>Una spedizione ogni venerd\xEC. Le tue tre catture migliori diventano Pok\xE9dollari.</p><div id="controls"></div><p id="mode-notice" role="status"></p><p id="notice" role="status" aria-live="polite">Caricamento della spedizione\u2026</p><div id="app"></div></main>`;
