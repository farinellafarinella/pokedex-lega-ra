...
import {getTrainerCompanion,SPECIES} from '../starter/starter-ui.js?v=arena-gifs-4';
import {FISH,RULES} from './config.mjs';
import {createBattle,turn,catchChance} from './engine.mjs?v=arena-gifs-4';
import {button,FishingScene,FishingBattle,FishingResult,RecordView,FishingLeaderboard,esc} from './components.mjs?v=arena-gifs-4';
